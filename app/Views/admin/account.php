...
>
  ...
  <body>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="<?= base_url(); ?>/panel/list" class="menu-link">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          src="<?= base_url(); ?>/admin/assets/img/avatars/1.png"
                          alt="user-avatar"
    ...
    <!-- Page JS -->
    <script src="<?= base_url(); ?>/admin/assets/js/pages-account-settings-account.js"></script>

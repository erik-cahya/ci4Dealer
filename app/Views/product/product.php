                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 element-item">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="<?= base_url(); ?>/img/product/e-<?= $prd["gambar_product"] ?>" alt="IMG-PRODUCT">

                            <a href="<?= base_url(); ?>/product/detail/<?= $prd["id_product"]; ?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15">
                                Quick View
                            </a>
                        </div>

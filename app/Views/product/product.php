    ...
    <div class="container">
        <div class="flex-w flex-sb-m p-b-52">
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                ...
                <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".bekas">
                    Bekas
                </button>
                <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".baru">
                    Baru
                </button>
            </div>
        ...
        <div class="row isotope-grid">
            ...
            <?php $number = 3 ?>
            <?php for ($product = 1; $product <= 4; $product++) : ?>
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item baru">
                    <!-- Block2 -->
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="img/product/e-p<?= $number++ ?>.png" alt="IMG-PRODUCT">
